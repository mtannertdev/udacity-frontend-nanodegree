...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
	// Simplified this to just apply the known values, not calculate every time
...
// Therefore, I had to come up with my own way to track the scroll value
var lastScrollY = 0;
function onScroll() {
  lastScrollY = window.scrollY;
}
// Registers the above function to track scroll bar Y value
